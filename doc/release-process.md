...
Ensure your gitian.sigs.dev are up-to-date if you wish to gverify your builds against other Gitian signatures.
...
### Build and sign Devcoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.dev/ ../devcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.dev/ ../devcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.dev/ ../devcoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  5. Gitian signatures (in `gitian.sigs.dev/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)
...
Commit your signature to gitian.sigs.dev:
    ...
    git commit -a
    git push  # Assuming you can push to the gitian.sigs.dev tree
    popd
...
Create (and optionally verify) the signed OS X binary:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.dev/ ../devcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.dev/ ../devcoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.dev/ -r ${VERSION}-win-signed ../devcoin/contrib/gitian-descriptors/gitian-win-signer.yml
