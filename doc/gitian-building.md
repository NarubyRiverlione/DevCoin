...
Output from `gbuild` will look something like
    ...
    From https://github.com/devcoin-project/devcoin
...
[gitian.sigs.ltc](https://github.com/devcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
