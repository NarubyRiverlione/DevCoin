...
const char * const BITCOIN_CONF_FILENAME = "devcoin.conf";
const char * const BITCOIN_PID_FILENAME = "devcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Devcoin";
#else
    // Unix
