 ...
 * database.
 *
 * CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot= , nTime=1492187400, nBits=0x1e0ffff0, nNonce=1140556, vtx=1)
...
{
    const char* pszTimestamp = "Times 2017-04-14 Get a broader perspective on Brexit";
...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 750; // 75% of MinerConfirmationWindow
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000");
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000");
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1492187400, 1140556, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe80d1386865295fed1221c72bcd91c7eb3247ca97213a97ac88bdc73100948fd"));
        assert(genesis.hashMerkleRoot == uint256S("0x1c74e134ecaf0f637aebc718ea3372255d035ab47d09248c07c1b32e555d4d37"));
	...
	checkpointData = (CCheckpointData){
		boost::assign::map_list_of
			( 0, uint256S("0xe80d1386865295fed1221c72bcd91c7eb3247ca97213a97ac88bdc73100948fd")),
			1492187400,
			0,
			0
	};
