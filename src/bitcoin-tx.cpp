...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s devcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  devcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded devcoin transaction") + "\n" +
              "  devcoin-tx [options] -create [commands]   " + _("Create hex-encoded devcoin transaction") + "\n" +
              "\n";
